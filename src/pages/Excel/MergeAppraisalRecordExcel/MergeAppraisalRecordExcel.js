...
const MergeAppraisalRecordExcel = (props) => {
  ...
  const loadMergeExcel=async (excelName)=>{
    const pathName=`${documentUrl}/office/excel/EmployeeAppraisalExcelManager/${excelName}`;
    userDoc=pathName;
...
export default MergeAppraisalRecordExcel;
