...
const MergeYearAppraisalRecordExcel = (props) => {
  ...
  const loadMergeExcel=async (excelName)=>{
    const pathName=`${documentUrl}/office/excel/EmployeeAppraisalExcelYear/${excelName}`;
    userDoc=pathName;
    setTimeout(()=>{
...
export default MergeYearAppraisalRecordExcel;
